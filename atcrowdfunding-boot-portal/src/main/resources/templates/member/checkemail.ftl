 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="email" name="email" value="${Session.loginmember.email}" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
	...
	<script>
        ...
        function nextStep(){
        	...
        	$.ajax({
        		type:"post",
        		url:"${APP_PATH}/member/checkemail",
        		data:{
        			"email":email
        		},
        		success:function(result){
        			if ( result.success ) {
                        ...
                        layer.msg("发送邮件失败", {time:1500, icon:5, shift:6});
                    }
        		}
        	});
